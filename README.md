...
### 3. Visualizing revenue across different cities and how they vary:
The visualization displays the top 14 cities with the highest sales. Jacksonville generated the highest revenue amongst all the cities. It can also be observed that majority of these sales came from the Technology category of products. This could be a contributing factor
